...
let names1 = ['Fatima', 'Ayesha', 'Anam ', 'Saima'];
...
let members = ['Fatima', 'Ayesha', 'Anam ', 'Saima'];
let mssg = 'Tommorrow you have to submit assingment:';
for (let i = 0; i < members.length; i++) {
    console.log(mssg + members[i]);
}
;
let names = ['Fatima', 'Ayesha', 'Anam ', 'Saima'];
let greeting_message = "You are invited on my birthday party.";
names.forEach(names => {
...
let transPortation = ['Toyota carolla', 'Honda motorcycle', 'Sports bike'];
...
let guest_list1 = ['Sara', 'Arif', 'Sabeen', 'Hina'];
...
let guest_list2 = ['Sara', 'Arif', 'Sabeen', 'Hina'];
...
let guest_list3 = ['Sara', 'Arif', 'Sabeen', 'Hina'];
...
let guest_list4 = ['Sara', 'Arif', 'Sabeen', 'Hina'];
...
//Exercise 17
let guest_list5 = ['Sara', 'Arif', 'Sabeen', 'Hina'];
...
let places = ['cape town', 'dehli', 'faisalabad', 'bankong', 'arab'];
...
let guest_list = ['Sara', 'Arif', 'Sabeen', 'Hina'];
...
let array = ['Sara', 'Reena', 3, 5, 8, 'Ali'];
console.log(array[0]);
console.log(array[1]);
console.log(array[2]);
console.log(array[3]);
...
let fruits = ['apple', 'mango', 'stawbery', 'grapes'];
...
let favourite_fruits = ['apple', 'stawbery', 'bananna'];
...
let users1 = ['admin', 'ali', 'hamza', 'davar', 'aisha', 'sana'];
...
let users = ['sana', 'ali', 'hamza', 'davar', 'aisha', 'admin'];
if (users.length === 0) {
...
let current_users = ['dua', 'anam', 'sami', 'alam', 'aqib'];
let new_users = ['sana', 'zarbab', 'sarim', 'qasim', 'dua'];
...
let kind_pizza = ['creamy tikka pizza', 'pepperoni pizza', 'fajita pizza'];
...
function male_shirt1(size, message) {
...
function male_shirt(size = "large", message = "I love TypeScript") {
...
console.log(album2);
console.log(album3);
function make_album2(artistName, albumTitle, numberOfTrakers) {
...
let magicians_name = ["john", "chiris", "brad"];
...
let magicians1 = ["john", "chiris", "brad"];
